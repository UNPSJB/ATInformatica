...
from .views import ReporteTotalOrdenes, ReporteCantidadOrdenes, ReporteTotalProductos, ReporteCantidadProductos, ReporteEvolucionFacturacionMensual, ReporteCargaTrabajoTecnico
urlpatterns = [
