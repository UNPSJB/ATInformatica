...
from .views import Reserva, TareaCreate, TareaDetail, TipoTareaCreate, TipoTareaList, TipoTareaDelete, TipoTareaUpdate, TipoTareaDetail
urlpatterns = [
    url(r'^agregar$', TareaCreate.as_view(), name='tarea_crear'),
    url(r'^detalle/(?P<pk>\d+)$', TareaDetail.as_view(), name='tarea_ver'),
    url(r'^reservar$', Reserva.as_view(), name='reserva_crear'),
