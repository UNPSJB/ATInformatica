...
from .views import ReservaCreate, TareaFinalizar, ObservacionCreate, TareaAceptar, TareaCreate, TareaDetail, TipoTareaCreate, TipoTareaDelete, TipoTareaUpdate, TareaCambiarPrecio
urlpatterns = [
